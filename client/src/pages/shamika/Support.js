        ...
        >
            <div className="flex flex-row w-[70%] h-[600px] bg-opacity-70">
                ...
                >
                    ...
                    <p className="lg:mx-32 opacity-30 py-1">Thank you for reaching out to us. At Salon Diamond, we are
                        dedicated
                    ...
                    <p className="lg:mx-32 opacity-30 py-1">Please explore our resources and get in touch with us
                        through the
