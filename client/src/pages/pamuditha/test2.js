            ...
            <div className="flex flex-row w-[70%] h-[600px] bg-opacity-70">
                ...
                >
                    <div className="p-8 rounded-lg w-full max-w-sm">
                        ...
                        <form>
                            <div className="mb-4">
                                <label htmlFor="username" className="block text-sm font-medium text-gray-700 julius-sans-one-regular">
                                    Username
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-6">
                                <label htmlFor="password" className="block julius-sans-one-regular text-sm font-medium text-gray-700">
                                    Password
                                </label>
                                <input
                                    type="password"
