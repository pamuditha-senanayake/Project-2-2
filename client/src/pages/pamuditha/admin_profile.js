        ...
        <div className="flex h-screen">
            ...
            <div className="w-[80%] h-full bg-pink-500 p-4 julius-sans-one-regular"
                ...
                <div className="flex items-center justify-center w-full mt-[20px]">
                    <div className="flex flex-row w-[80%] h-[80%] space-x-2 border-2 rounded-2xl py-3 px-3">
                        ...
                        <div className="w-[30%] h-[100%] rounded-2xl justify-between bg-pink-300 px-2 pt-3">
                            <h1 className="julius-sans-one-regular text-3xl">Do you want to delete the profile?</h1>
                            <button
                                className="mt-8 py-3 px-4 bg-pink-500 hover:bg-pink-700 text-white font-bold rounded-lg shadow-lg w-full transition duration-300 ease-in-out"
