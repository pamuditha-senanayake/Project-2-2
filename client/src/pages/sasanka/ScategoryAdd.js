...
const ServicesPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchServices = async () => {
            try {
                const response = await axios.get("http://localhost:3001/api/cart/services");
    ...
    const handleDeleteClick = async (id) => {
        try {
            await axios.delete(`http://localhost:3001/api/cart/services/${id}`);
    ...
    const handleUpdateService = async () => {
        try {
            await axios.put(`http://localhost:3001/api/cart/services/${selectedService.id}`, selectedService);
