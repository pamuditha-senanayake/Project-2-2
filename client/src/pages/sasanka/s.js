...
//             try {
//                 const response = await axios.get('http://localhost:3001/api/categories'); // Update with your categories endpoint
...
//                 ...formData,
//                 categoryId: formData.categoryId, // Ensure this is included
//                 time: formData.time // Match the backend field
//             });
