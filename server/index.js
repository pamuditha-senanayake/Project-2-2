...
app.post('/api/products', async (req, res) => {
  ...
  try {
    await pool.query(
        'INSERT INTO products (name, category, price, quantity, description) VALUES ($1, $2, $3, $4, $5)',
...
app.put('/api/products/:id', async (req, res) => {
  ...
  try {
    await pool.query(
        'UPDATE products SET name=$1, category=$2, price=$3, quantity=$4, description=$5 WHERE id=$6',
